...
class CouponTableViewController: UITableViewController {
    ...
    let couponData = dataCenter.coupons
    ...
    override func tableView(_ tableView: UITableView, cellForRowAt indexPath: IndexPath) -> UITableViewCell {
        ...
        cell.imageView?.image = currentCoupon.photo.first
        cell.textLabel?.text = currentCoupon.marketName
        cell.detailTextLabel?.text = currentCoupon.productName
